...
return this}}(jQuery);(function($,_){_.boohee={toPostData:function(serializeData){var data={};_.each(serializeData,function(item,key){data[item.name]=item.value;});return data;}};})($,_);