!function (n, e, t) {
    ...
    1: [function (n, e, t) {
        ...
        var u = n(30), c = n(18), f = {"%2C": ",", "%3A": ":", "%2F": "/", "%40": "@", "%24": "$", "%3B": ";"},
            d = u(f, function (n) {
                return n
        ...
        var m = n(15), h = n(30), v = n(12), g = n(6), y = n(18), w = n(19), x = n(33), b = n(2), k = n(17),
            j = n("loader"), E = n(4), S = "1071.385e752", A = "NREUM.setToken", q = {}, I = !!navigator.sendBeacon;
        n(9);
        ...
        var o = n(14), i = n(1), a = n(16), s = n(17), u = n(15), c = n(8), f = n(13), d = n(7), l = n("loader"),
            p = n(29), m = n(5);
        n(3);
        ...
        var a = "Start", s = "End", u = "unloadEvent", c = "redirect", f = "domainLookup", d = "onnect", l = "request",
            p = "response", m = "loadEvent", h = "domContentLoadedEvent", v = [];
        ...
        function l(n) {
            ...
            var t, r, o, i = /^\s*Line (\d+) of linked script ((?:file|http|https)\S+)(?:: in function (\S+))?\s*$/i,
                ...
                l = document.getElementsByTagName("script"), p = [], v = !1;
        ...
        var p = n(33), m = n(22), h = Object.prototype.hasOwnProperty, v = !1, g = /function (.+?)\s*\(/,
        ...
        function s(n, e, t) {
            if (e = e || p.now(), t || !p.onerror || !p.onerror(n)) {
                var o = a(d(n)), s = i(o),
                    c = {stackHash: l(s), exceptionClass: o.name, request_uri: window.location.pathname};
        ...
        var u = n(2), c = n(20), f = n(4), d = n(21), l = n(24), p = n("loader"), m = n("ee"), h = {}, v = {},
            g = n(13), y = n(8), w = n(11), x = n(18), b = n("handle"), k = n("ee"), j = {};
        ...
        var i, a = n("ee"), s = n("loader"), u = n(30), c = n(18), f = n(13), d = n(8), l = n(4), p = n(11), m = 120,
            h = 30, v = m * h / 60, g = [], y = s.info.jsAttributes = {};
        ...
        if (k.xhrUsable && x.xhrWrappable) {
            var N = "", T = {mouseup: !0, mousedown: !0},
                _ = {typing: [1e3, 2e3], scrolling: [100, 1e3], mousing: [1e3, 2e3], touching: [1e3, 2e3]}, R = {
